...
<html>
	...
	<div id="livreContainer">
		<div class="container text-center border p-5 mt-5 mb-5">
			<p class="font-weight-bold h4 styleSelection">Ajouter des documents</p>

			<div class="row d-flex justify-content-between">
				<ul class="list-group col-3 mt-3 row" id="listEmprunt">
					<p class="styleSelection">Documents présents</p>
				...
				<ul class="list-group col-3 mt-3 row" id="formAjout">
	              ...
	              <form method="get" action="ajoutdoc">
				  	...
				  	<div class="form-group">
  	                  <label for="inputTitre" class="styleSelection">Titre</label>
  	                  <input name="inputTitre" type="text" class="form-control styleSelection" aria-describedby="emailHelp" placeholder="Titre du document">
  	                </div>

  	                <div class="form-group">
  	                  <label for="inputAuteur" class="styleSelection">Auteur</label>
  	                  <input name="inputAuteur" type="text" class="form-control styleSelection" placeholder="Auteur du document">
  	                </div>

	                <label class="mr-sm-2 styleSelection" for="inlineFormCustomSelect" >Type</label>
